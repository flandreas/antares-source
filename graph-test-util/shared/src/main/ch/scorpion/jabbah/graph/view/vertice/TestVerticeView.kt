...
/**
 * Contains an input [ch.scorpion.jabbah.graph.view.port.TestPortView] directed to [ch.scorpion.jabbah.base.geom.Direction.WEST] and an output [ch.scorpion.jabbah.graph.view.port.TestPortView]
 * directed to [ch.scorpion.jabbah.base.geom.Direction.EAST].
 */
