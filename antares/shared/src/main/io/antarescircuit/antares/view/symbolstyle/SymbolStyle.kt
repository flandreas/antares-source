...
import io.antarescircuit.antares.view.analog.AnalogLEDView.Companion.GRADIENT_RADIUS
import io.antarescircuit.antares.view.gate.BoxGateView
import io.antarescircuit.antares.view.gate.CustomShapeContent
...
enum class SymbolStyle(
	...
	companion object {
		...
		const val PROP_SYMBOL_STYLE = "io.antarescircuit.antares.view.symbolStyle"
		...
		const val PROP_TRI_STATE_ALWAYS_TRIANGLE = "io.antarescircuit.antares.view.triStateAlwaysTriangle"
