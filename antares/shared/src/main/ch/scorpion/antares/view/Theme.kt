...
class Theme(
        ...
        val vertice: Style,
        val edge: EdgeStyle,
        val annotation: Style,
        val explanation: Style,
        val highlight: Style,
        val message: Style,
        val subsystem: Style,
        val selection: CompositeColor,
        val zero: CompositeColor,
        val one: CompositeColor,
        val undefined: CompositeColor,
        val word: CompositeColor,
        val wordZero: CompositeColor,
        val error: CompositeColor,
        val focus: Style
) {

    companion object {

        /** Holds all registered [Theme]s.*/
        ...
        var current: Theme = getTheme("winter")!!

        /**
         * Sets the predefined [Theme] with the specified name as the current [Theme].
         * @throws NoSuchElementException if the specified [Theme] doesn't exist
         */
        fun setCurrent(name: String) {
            current = getTheme(name) ?: throw NoSuchElementException("No theme with name '$name' defined")
        }

        /** Determines whether a predefined [Theme] with the specified name exists.*/
        fun exists(name: String): Boolean {
            return getTheme(name) != null
        }

        /** Returns the registered [Theme] with the specified name, if any.*/
