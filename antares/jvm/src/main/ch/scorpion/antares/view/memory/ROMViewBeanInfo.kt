...
class ROMViewBeanInfo : DigitalComponentBeanInfo<ROMView>() {
	...
	companion object {
		...
		private val disassemblerConfig = PropertyImpl("disassemblerConfig", "element.property.ROM.disassemblerConfig", ScriptProperty::class.java, componentBeanProvider)
