...
class Bug227 : AbstractFileBasedTest() {
	...
	fun openAndStartCircuit() {
		...
		a = openedCircuitView.graph!!.withId(8) as Switch
	...
	fun shouldSendSignalToOutside() {
		...
		assertEquals(Word.of(true), subGraphVerticeRef.getOutput<DigitalSignal>("D").getOutgoingSignal())
	}
}