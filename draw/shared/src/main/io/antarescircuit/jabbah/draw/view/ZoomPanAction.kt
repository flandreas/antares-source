...
object ZoomPanActions {
	val zoomNormalAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomNormalAction
	val zoomInAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomInAction
	val zoomOutAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomOutAction
	val zoomFitAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomFitAction
	val zoomFitMaxNormalAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomFitMaxNormalAction
	val zoomCenterAction: Action get() = io.antarescircuit.jabbah.draw.view.zoomCenterAction
}
