...
class ToolBarBuilderFx(
	private val editor: Editor,
	private val adder: (Component) -> Component = { it }
) {
	...
	fun build(): ToolBar {
		...
		toolbar.items.add(ActionWrapperFx.imageButton(ToggleButton(),
			ToolAction("edit.tool.rectangle", RectangleTool(editor, { RectangleComponent() }, adder), editor, "/img/rectangle24.png")))
		toolbar.items.add(ActionWrapperFx.imageButton(ToggleButton(),
			ToolAction("edit.tool.ellipse", RectangleTool(editor, { EllipseComponent() }, adder), editor, "/img/oval24.png")))
		toolbar.items.add(ActionWrapperFx.imageButton(ToggleButton(),
			ToolAction("edit.tool.polyline", PolylineTool(editor, { PolylineComponent() }, adder), editor, "/img/polyline24.png")))
		toolbar.items.add(ActionWrapperFx.imageButton(ToggleButton(),
			ToolAction("edit.tool.curve", QuadCurveTool(editor, { QuadCurveComponent() }, adder), editor, "/img/curve24.png")))

		toolbar.items.add(ActionWrapperFx.imageButton(ToggleButton(),
			ToolAction("edit.tool.text", TextTool(editor, { TextComponentJvm("Text") }, adder), editor, "/img/text24.png")))
