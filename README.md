...
The Antares application universe currently consists of the following components, which are named after stars in the star constellation "Scorpius" ([Change the domain](https://github.com/flandreas/antares-source/issues/3)):
...
Make sure that all changes from older release branches or feature branches have been merged to the master.
