...
interface Path : Shape {
    ...
    /**
     * Adds a curved segment, defined by the two points, to the path by drawing a quadratic curve that intersects
     * both the current coordinates and the specified new coordinates.
     */
