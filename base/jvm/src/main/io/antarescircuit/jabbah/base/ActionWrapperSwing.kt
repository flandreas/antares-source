...
class ActionWrapperSwing(
	...
	companion object {
		...
		fun toJabbahActionEvent(e: ActionEvent): io.antarescircuit.jabbah.base.event.ActionEvent =
			io.antarescircuit.jabbah.base.event.ActionEvent(
				event = e,
				source = e.source,
		...
		fun toJabbahActionEvent(e: MouseEvent): io.antarescircuit.jabbah.base.event.ActionEvent =
			io.antarescircuit.jabbah.base.event.ActionEvent(
				event = e,
				source = e.source,
