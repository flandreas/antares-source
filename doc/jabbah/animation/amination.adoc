...
image::../../model-img/svg/jabbah__animation__Animation Core Abstractions_14.svg[]
...
image::../../model-img/svg/jabbah__animation__AnimatorImpl__Interaction1__Animation_12.svg[]
