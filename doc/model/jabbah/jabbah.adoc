...
Candidates star names for additional, future software packages in the `io.antarescircuit` domain:
...
image::../model-img/svg/jabbah__Package Overview_0.svg[]

* <<base/base.adoc#, *base:*>> Some base concepts and classes that don't depend on other `jabbah` packages.
...
* <<io/io.adoc#, *io:*>> Allows storing and loading of objects and object graphs to and from persistent storage,
 such as flat files.

* <<animation/animation.adoc#, *animation:*>> A simple framework that supports repeated, fluent changing of graphical
and non-graphical values, which can be used to implement graphical animations.

* <<draw/draw.adoc#, *draw:*>> Provides functionality for creating and displaying 2D drawings.

* <<edit/edit.adoc#, *edit:*>> Provides functionality for interactive editing of 2D drawings.

* <<execution/execution.adoc#, *execution:*>> Provides an actor representation and functionality for asynchronous
scheduling of signals flowing between objects. This can be used for implementing simulation and animation of discrete
dynamic systems.

* <<app/app.adoc#, *app:*>> A simple application framework that features an `Application` base class and support for
loading and storing application state, and for building a UI containing actions, menus and tool bars.

* <<graph/graph.adoc#, *graph:*>> A sophisticated framework for building graphs of vertices that are connected with edges.
...
* <<antares/antares.adoc#, *antares:*>> An application for building, simulating and animating digital circuits.
...
/draw
   /jvm
      /src
         /demo
            io.antarescircuit.jabbah.draw
         /main
            io.antarescircuit.jabbah.draw
   /shared
      /src
         /demo
            io.antarescircuit.draw.hellopgraphics
         /main
            io.antarescircuit.jabbah.draw
         /test
            io.antarescircuit.jabbah.draw
/draw-web
   /demo
      /hellographics
         /kotlin
            io.antarescircuit.jabbah.draw.hellographics
   /main
      /kotlin
         io.antarescircuit.jabbah.draw
----
