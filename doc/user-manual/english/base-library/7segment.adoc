=== image:../../img/base-library/7segment.png[7Segment display] 7-Segment Display

==== Appearance

image:../../img/base-library/7segment-sample.png[Example 7-Segment, 400]
...
image::../../img/base-library/7segment-schema.png[Pin diagram, 200]
