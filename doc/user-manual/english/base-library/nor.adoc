=== image:../../img/base-library/nor.png[NOR] NOR gate

==== appearance

image:../../img/base-library/nor-sample.png[Example NOR, 300]
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. Below is the mnemonic of the NOR gate.

image:../../img/base-library/nor-mnemonic.png[Example Mnemonic, 300]
