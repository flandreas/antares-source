...
image:../../img/base-library/ram-sample.png[Example RAM, 600]

==== Behavior

The RAM is a <<memory.adoc#, memory>> component whose data can be read and written by the using circuit during simulation.
