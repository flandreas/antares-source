=== image:../../img/base-library/nand.png[NANDd] NAND Gate

==== Appearance

image:../../img/base-library/nand-sample.png[Example NAND, 300]
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. Below is the mnemonic of the NAND gate.

image:../../img/base-library/nand-mnemonic.png[Example Mnemonic, 300]
