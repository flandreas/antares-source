=== image:../../img/base-library/rom.png[ROM] image:../../img/base-library/ram.png[RAM] Memory
:experimental:

This chapter describes properties that apply to both the <<rom.adoc#, ROM>>- and the <<RAM.adoc#, RAM>> component.
