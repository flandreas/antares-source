=== image:../../img/base-library/splitter.png[Splitter] Splitter

==== appearance

image:../../img/base-library/splitter-sample.png[Splitter,300]
...
In the current version of Antares, the splitter does not support bidirectional pins. Therefore, for combining wires into wire bundles, the <<combiner.adoc#, combiner component>> must be used.
