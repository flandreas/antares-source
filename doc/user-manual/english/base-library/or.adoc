=== image:../../img/base-library/or.png[OR] OR Gate

==== Appearance

image:../../img/base-library/or-sample.png[Example OR gate, 300]
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. The mnemonic of the OR gate is shown below.

image:../../img/base-library/or-mnemonic.png[Example Mnemonic, 300]
