=== image:../../img/base-library/tristate-buffer.png[Tri-State Buffer] Tri-State Buffer

==== appearance

image:../../img/base-library/tristate-buffer-sample.png[Example Tri-State Buffer, 200]
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. The mnemonic of the tri-state buffer is shown below.

image:../../img/base-library/tristate-buffer-mnemonic.png[Mnemonic Tri-State Buffer, 200]
