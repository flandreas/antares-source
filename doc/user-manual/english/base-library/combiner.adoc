=== image:../../img/base-library/concentrator.png[Combiner] Combiner

==== Appearance

image:../../img/base-library/combiner-sample.png[Example combiner, 300]
...
In the current version of Antares, the combiner does not support bidirectional pins. To split wire bundles to narrower bundles (or single wires), the <<splitter.adoc#, splitter component>> must therefore be used.
