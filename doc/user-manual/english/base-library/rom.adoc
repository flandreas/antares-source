...
image:../../img/base-library/rom-sample.png[Example ROM, 500]
...
See the chapter <<memory.adoc#, Memory>> for a description of the general memory attributes. This section only describes the special attributes of the ROM component.
