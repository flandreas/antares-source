=== image:../../img/base-library/and.png[And] AND Gate

==== Appearance

image:../../img/base-library/and-sample.png[Example AND gate, 300, align="left"]
...
image:../../img/base-library/and-path-sample.png[Example AND-path, 75%]

=== Mnemonics

The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. The mnemonic of the AND gate is shown below.

image:../../img/base-library/and-mnemonic.png[Example Mnemonic, 300]
