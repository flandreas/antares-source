=== image:../../img/base-library/xnor.png[XNOR] XNOR gate

==== Appearance

image:../../img/base-library/xnor-sample.png[Example XNOR gate, 300].
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. The mnemonic of the XNOR gate is shown below.

image:../../img/base-library/xor-mnemonic.png[Example Mnemonic, 300]
