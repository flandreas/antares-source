...
* image:user-manual/base-library/double-throw-switch.png[Double-Throw Switch] link:{{site.basedir}}/user-manual/english/base-library/double-throw-switch[Double-Throw Switch]
