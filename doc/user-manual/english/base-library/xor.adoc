=== image:../../img/base-library/xor.png [XOR] XOR gate

==== Appearance

image:../../img/base-library/xor-sample.png[Example XOR gate, 300]
...
The logical gates of Antares can illustrate their function with so-called "mnemonics". See the chapter <<../description/description.adoc, Descriptions and explanations>>. The mnemonic of the XOR gate is shown below.
