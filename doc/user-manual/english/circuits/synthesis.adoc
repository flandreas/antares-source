...
The boolean expressions window contains a text area where you can enter your boolean expressions. A sample texts shows the various expression formats supported by Antares. Enter a separate expression for every variable on a separate line.
