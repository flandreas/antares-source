...
image::workbench-sample.png[Workbench,300,align="center"]

This chapter describes the properties and possibilities of the workbench, which apply equally to projects and libraries opened in it. The special properties of <<projects.adoc#, Projects>> and <<libraries.adoc#, Libraries>> are explained in the corresponding chapters.
