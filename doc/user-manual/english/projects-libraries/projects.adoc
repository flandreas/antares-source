...
In this chapter you will learn how to manage your own projects. The basics of projects are explained in <<projects-libraries.adoc#, "Projects and Libraries">>.

==== manage projects

The main menu menu:File[Projects...] takes you to the Antares project management.

image::projects-sample.png[Projects,500,align="center"]
