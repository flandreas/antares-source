...
In this chapter you will learn how to create your own libraries. The basics of libraries are explained in <<projects-libraries.adoc#, "Projects and Libraries">>.

==== Manage libraries

The main menu menu:File[Libraries...] leads you to the Antares library management.

image::libraries-sample.png[libraries,400,align="center"]
...
image::libraries-attributes.png[properties,400,align="center"]
...
image::libraries-edit.png[Edit,600,align="center"]
