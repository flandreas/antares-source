...
image::usecases-dropdown.png[execution, 500,align="center"]

When the user starts the execution of a use case, Antares automatically switches to simulation mode and starts the use case script. All possibilities of the simulation mode are available, such as controlling the simulation speed, single step mode or signal animation. If <<../scenarios/scenarios.adoc#, Scenarios>> are defined for the current circuit, they will also be applied and their descriptions will be displayed during the execution of the use case.
...
image::usecases-panel.png[Example use cases, 500,align="center"]
