...
In the chapter <<../first-steps/first-steps.adoc#, "First Steps">> you have already made your first experiences with the creation and reuse of partial circuits. The chapter <<../circuits/circuits.adoc#, "Circuits">> describes in detail how to create circuits.

This chapter describes how to build a circuit that can be used as subcircuits in other circuits.

=== Ports

<<../base-library/port.adoc#, Ports>> (inputs, outputs) are the most important components for the construction of subcircuits. They are used to transfer signals from the surrounding circuit to the subcircuit and to return signals to the surrounding circuit.
...
image::../../img/subcircuits/bidirectional-port.png[Bidirectional connections, 400,align="center"]
...
image::../../img/subcircuits/view-tools.png[View tools, 100]
...
image::symbol-editor-tree.png[tree, 250, align="center"]
...
Port ID :: Displays the ID of the port (cannot be changed). This ID can be used for <<../scripting/scripting.adoc#, Scripting>> applications.
