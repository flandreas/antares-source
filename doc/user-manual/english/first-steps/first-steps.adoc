...
image::./orientation.png[Orientation, 800, align="center"]
...
image::gates.png[Gates, 700, align="center"]
...
image::inout.png[Inputs and outputs, 700, align="center"]
...
image::wires.png[connections, 700, align="center"]
...
With Antares, digital circuits can not only be drawn, but also executed. Press the button with the interrupted circle symbol in the simulation tools to start the simulation.
...
image::simulationTool.png[Simulation Tool, 400, align="center"]
...
image::animation.png[Animation, 700, align="center"]
...
The circuit cannot be edited in simulation mode. Press the button with the interrupted circle symbol in the simulation tools to return to the edit mode.
...
image::symboleditor.png[symbol editor, 700, align="center"]
...
image::symboleditor-final.png[Finished symbol, 700, align="center"]
...
image::component-usage.png[Component usage, 700, align="center"]
...
image::navigation-bar.png[Navigation bar, 500, align="center"]
...
image::subview.png[Subview, 700, align="center"]
