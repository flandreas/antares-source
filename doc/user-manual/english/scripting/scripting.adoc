...
image::script-attribute.png[script property, 300]
...
image::scripting-editor.png[Script Editor, 500, align=center]
...
image::scripting-error.png[Script error, 700, align=center]
...
* <<../circuits/circuit-scripting.adoc#, Skriting in circuits>>
* <<../scenarios/scenario-scripting.adoc#, Scripting in scenarios>>