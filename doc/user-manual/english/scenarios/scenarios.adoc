...
image::scenarios-sample.png[Example scenarios, 500,align="center"]
...
image::scenario-panel.png[Scenario configuration, 300,align="center"]
...
See <<../scripting/scripting.adoc#, Scripting>> for details on scripting.  +
+
.Example
[source,javascript]
----
