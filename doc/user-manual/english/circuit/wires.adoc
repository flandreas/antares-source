...
Wires are circuit elements with which pints of components can be connected, so that during
simulation of the circuit signals can flow between the components.

image::../../img/circuits/wires-sample.png[wires,250,align="center"]
...
image::inconsistent-net.png[Inconsistent net,400,align="center"]
...
image::../../img/circuits/auto-connect.png[Automatic Connecting,300,align="center"]
...
image::../../img/circuits/wire-styles.png[Line styles,600,align="center"]
