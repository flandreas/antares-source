...
image::../../img/circuits/wires-sample.png[Leitungen,300,align="center"]
...
Um die Erzeugung einer neuen Leitung zu beginnen, bewegst Du die Maus über einen Anschluss einer Komponente oder eine bereits vorhandene Leitung. Antares zeigt Dir dann mit einem kleinen orangen Kreis an, dass Du an dieser Stelle eine neue Leitung beginnen kannst.
...
Leitung zu Eingang:: Um eine neue Leitung auf einer bereits bestehenden Leitung zu beginnen (Abzweigung), bewegst Du die Maus über die bestehende Leitung und drückst die ALT-Taste. Halte die ALT-Taste während dem Ziehen gedrückt.
...
Standardmässig erzeugt Antares während der Erzeugung der Leitung selbstständig ein rechtwinkliges Layout. Um das Layout der entstehenden Leitung zu beeinflussen, drückst Du bei der Bestimmung des Startortes die ALT-Taste. Antares zeigt dann statt des orangen Kreises ein oranges Quadrat an. Danach kannst Du die Zwischenpunkte der enstehenden Leitung durch Klicks mit der linken Maustaste bestimmen. Dabei muss beim Bewegen der Maus die Maustaste nicht mehr gedrückt gehalten werden.
...
image::../../img/circuits/inconsistent-net.png[Inkonsistentes Netz,400,align="center"]
...
image::../../img/circuits/auto-connect.png[Automatisches Verbinden,400,align="center"]
...
Gerade:: Bei diesem Layout wird eine gerade Verbindung zwischen Anfangs- und Endpunkt der Leitung gezeichnet. Dieses Layout aus Gründen der Vollständigkeit vorhanden, wird aber in digitalen Schaltungen eher selten verwendet. +
 +
