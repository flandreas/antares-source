...
Mit Antares können digitale Schaltungen nicht nur gezeichnet, sondern auch ausgeführt werden. Drücke in den Simulationswerkzeugen auf den Knopf mit dem Pfeil, um die Simulation zu starten.
...
Im Simulationsmodus kann die Schaltung nicht bearbeitet werden. Drücke in den Simulationswerkzeugen auf den Knopf mit Pfeil, um zurück in den Bearbeitungsmodus zu gelangen.
