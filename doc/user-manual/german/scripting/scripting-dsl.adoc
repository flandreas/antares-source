...
`input(<Name>)`:: Returns the signal of the `GraphInput` with the specified name as as string.
+
.Example
[source,javascript]
----
...
`output(<Name>)`:: Returns the signal of the `GraphOutput` with the specified name as a string.
+
.Example
[source,javascript]
----
...
`input()`:: Returns the signal of the first (or one and only) `InputPort` as a string.
+
.Example
[source,javascript]
----
...
`input(<name:String>)`:: Returns the signal of the `InputPort` with the specified name as a string.
+
.Example
[source,javascript]
----
...
`input(<ID:Int>)`:: Returns the signal of the `InputPort` with the specified ID as a string.
+
.Example
[source,javascript]
----
...
`output()`:: Returns the signal of the first (or one and only) `OutputPort` as a string.
+
.Example
[source,javascript]
----
...
`output(<ID:Int>)`:: Returns the signal of the `OutputPort` with the specified ID as a string.
+
.Example
[source,javascript]
----
