...
In diesem Fenster schreibst du dein Skript als JavaScript-Code. Mit der Schaltfläche "OK" wird das aktuelle Skript im Attribut gespeichert, in dem du den Skript-Editor geöffnet hast.
...
* <<circuit-scripting.adoc#, Skriting in Schaltungen>>
* <<scenario-scripting.adoc#, Skripting in Szenarien>>