...
image:../../img/simulation/play24.png[Start] Mit dieser Schaltfläche (kbd:[Ctrl + R]) kann die Simulation gestartet und gestoppt werden.

image:../../img/simulation/pause24.png[Pause] Aktiviert den Einzelschrittmodus der Simulation.

image:../../img/simulation/resume24.png[Fortsetzen] Führt den nächsten Einzelschritt aus (kbd:[Ctrl + Space]). Ist nur aktiv, wenn der Einzelschrittmodus aktiviert ist. Die Schaltfläche wird mit einem orangen Rahmen dargestellt, wenn ein Einzelschritt möglich ist.
