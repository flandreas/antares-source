...
Test ausführen:: Kontextmenü auf dem Anwendungsfall-Knoten, das nur aktiv ist, falls für den ausgewählten Anwendungsfall ein Testfall vorhanden ist. Führt den Anwendungsfall sowie das Testfall-Skript aus.
