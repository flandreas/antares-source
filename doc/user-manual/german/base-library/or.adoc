...
image:../../img/base-library/or-sample.png[Beispiel Oder-Gatter, 50%]

==== Verhalten

Das Oder-Gatter gibt am Ausgang das Resultat der OR-Verknüpfung der 1-Bit-Signale am Eingang aus. Der Ausgang hat nur dann den Wert "0", wenn alle Eingänge den Wert "0" haben.
...
image:../../img/base-library/or-mnemonic.png[Beispiel Mnemonic, 50%]
