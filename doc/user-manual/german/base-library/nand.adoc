...
image:../../img/base-library/nand-sample.png[Beispiel Nicht-Und-Gatter, 50%]

==== Verhalten

Das Nicht-Und-Gatter gibt am Ausgang das Resultat der NAND-Verknüpfung der 1-Bit-Signale am Eingang aus. Der Ausgang hat nur dann den Wert "0", wenn alle Eingänge den Wert "0" haben.
...
image:../../img/base-library/nand-mnemonic.png[Beispiel Mnemonic, 50%]
