...
Das Und-Gatter gibt am Ausgang das Resultat der Und-Verknüpfung der 1-Bi-Signale am Eingang aus. Der Ausgang hat nur dann den Wert "1", wenn alle Eingänge den Wert "1" haben.

Unverbundene Eingänge haben immer den Wert "0". Wenn einer der Eingänge explizit "undefiniert" ist, ist der Ausgang 0, wenn mind. einer der Eingänge den Wert "0" hat, ansonsten hat der Ausgang den Wert "Error". Wenn irgendeiner der Eingänge den Wert "Error" hat, hat der Ausgang ebenfalls den Wert "Error".
