...
image:../../img/base-library/and-sample.png[Beispiel Und-Gatter, 300, align="left"]
...
image:../../img/base-library/and-mnemonic.png[Beispiel Mnemonic, 300]
...
Name des Ausgangs:: Der optionale Name, der neben dem Ausgang dargestellt wird. Dies kann nützlich sein, wenn das Und-Gatter das Ende einer komplexen kombinatorischen Schaltung bildet und der logische Ausdruck angegeben werden soll, der durch das Und-Gatter produziert wird.

Daten-Eingang:: In diesem Attribut kann die Nummer des Eingangs gewählt werden, der den Datenpfad enthält, wenn das Feature "Daten-Pfad" (siehe oben) verwendet werden soll. In Richtung des Datenflusses durch das Und-Gatter bezeichnet die Nummer 1 den Ausgang ganz oben.