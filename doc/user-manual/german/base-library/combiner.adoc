...
image:../../img/base-library/combiner-sample.png[Beispiel Konzentrierer, 50%]
...
Position Bit 0:: Mit Hilfe dieses Attributs kann die Position der Eingänge innerhalb des Konzentierers bestimmt werden.
...
* **Links**: Der Eingang, der das Bit 0 führt, liegt aus Sicht des am Ausgang ausgehenden Signals auf der linken Seite des Konzentrierers.
