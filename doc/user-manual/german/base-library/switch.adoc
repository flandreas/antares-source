...
Ein gedrückter Schalter erzeugt nicht sofort ein Signal am Ausgang, sondern erst nach Ablauf der eingestellten Verzögerungszeit, die standardmässig auf 1'000 ns eingestellt ist. Bis diese Verzögerungszeit abgelaufen ist, nimmt der Schalter keine weiteren Eingaben entgegen. Dies wird ersichtlich, wenn die Simulation im Einzelschritt-Modus ausgeführt wird: Der Schalter wird bis zum Ablauf der Verzögerungszeit als "inaktiv" (mit grauer Fläche überlagert) dargestellt.
