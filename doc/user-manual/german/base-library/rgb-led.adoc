...
image:../../img/base-library/rgb-led-sample.png[Beispiel LED, 300]
...
Eine RGB-LED hat nur einen einzigen Eingang der Bit-Breite 24. Die höchstwertigen 8 Bits enthalten den Wert des roten Farbkanals, die mittleren 8 Bit enthalten den Wert des grünen Farbkanals, und die tiefstwertigen 8 Bits enthalten den Wert des blauen Farbkanals.
