...
image:../../img/base-library/tristate-buffer-sample.png[Beispiel Tri-State Puffer, 50%]
...
image:../../img/base-library/tristate-buffer-mnemonic.png[Mnemonic Tri-State Puffer, 50%]

==== Anschlüsse

Dateineingang:: Der Eingang des Puffers.

EN:: "Enable" - Kontrolleingang TODO
...
Ausrichtung Kontrolleingang:: TODO
