...
image:../../img/base-library/tristate-buffer-sample.png[Beispiel Tri-State Puffer, 200]
...
image:../../img/base-library/tristate-buffer-mnemonic.png[Mnemonic Tri-State Puffer, 200]
