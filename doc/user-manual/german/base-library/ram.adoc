...
image:../../img/base-library/ram-sample.png[Beispiel RAM, 75%]
...
D:: Eingang/Ausgang "Data": Gibt die Daten, die gelesen werden, oder übernimmt die Daten, die geschrieben werden, je nach Wert der Eingänge "WR" und "CLK".
