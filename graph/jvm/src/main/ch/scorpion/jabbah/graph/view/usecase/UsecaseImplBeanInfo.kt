...
class UsecaseImplBeanInfo : AbstractBeanInfo<UsecaseImpl>() {
	...
	private val execScript = PropertyImpl("graph.property.usecase.execScript", ScriptProperty::class.java)
	private val testScript = PropertyImpl("graph.property.usecase.testScript", ScriptProperty::class.java)
