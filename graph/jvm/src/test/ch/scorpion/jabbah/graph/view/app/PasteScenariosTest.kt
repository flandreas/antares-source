...
import ch.scorpion.jabbah.edit.app.PasteCommand
...
class PasteScenariosTest : AbstractGraphViewEditingTest() {
    ...
    fun shouldRedoPasteAtSameLocation() {
        ...
        editor.commandManager.register(PasteCommand(view as DrawingView<Drawing<Component>>, content, pasteInfo, copyPasteService))
