...
class NodeViewImplTest {
    ...
    fun setup(){
        ...
        v1 = builder.addVertice(TestVerticeView(Point2D(100, 100)))
        v2 = builder.addVertice(TestVerticeView(Point2D(200, 100)))
        v3 = builder.addVertice(TestVerticeView(Point2D(200, 200)))
