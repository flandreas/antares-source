...
class AutoConnectorTest {
    ...
    private val v1 = builder.addVerticeView(TestVerticeView.createEastOutputVerticeView("v1", 100, 100))
    private val v2 = builder.addVerticeView(TestVerticeView.createEastOutputVerticeView("v2", 200, 100))
    private val editor = EditorImpl(DrawingViewImpl(builder.build() as Drawing<Component>))
