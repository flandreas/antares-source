...
import io.antarescircuit.jabbah.execution.actor.ActorViewBag
...
import io.antarescircuit.jabbah.graph.container.DrawExecSymbolFunctions
...
import io.antarescircuit.jabbah.graph.view.port.PortViewReuser
...
class SubGraphVerticeViewImpl(
	...
	override fun createSubGraphView(signalHandler: SignalHandler?): GraphView {
		...
		if (signalHandler != null) {
			graphView.executionStart(signalHandler)
		}
		return graphView
	}
