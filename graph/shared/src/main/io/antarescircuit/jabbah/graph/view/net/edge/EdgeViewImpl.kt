...
import io.antarescircuit.jabbah.draw.polyline.LineTerminator
import io.antarescircuit.jabbah.draw.polyline.PolylineShape
import io.antarescircuit.jabbah.draw.polyline.PolylineShapeFactory
...
import io.antarescircuit.jabbah.graph.view.EdgeView.Companion.PROP_MIN_EDGE_VIEW_LENGTH
...
import io.antarescircuit.jabbah.graph.view.net.netview.NetViewTraversal
...
open class EdgeViewImpl<T : Any>(
	...
	override val edgeToPortOrEdgeConnector: EdgeToPortOrEdgeConnector get() = GraphViewModule.edgeToPortOrEdgeConnector
	...
	override val originEndpointView: EdgeEndpointView = EdgeEndpointView(this, ORIGIN, styleProvider)

	override val destinationEndpointView: EdgeEndpointView = EdgeEndpointView(this, DESTINATION, styleProvider)
	...
	protected fun drawBeginConnectionAnnotation(context: DrawContext) {
		beginConnectionAnnotatePoint?.let {
			context.g.color = io.antarescircuit.jabbah.draw.graphics.Color.YELLOW
