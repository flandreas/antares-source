...
import io.antarescircuit.jabbah.graph.app.ApplicationMode.EDIT
...
abstract class AbstractLibraryAction(
	...
	/**
	 * [io.antarescircuit.jabbah.graph.GraphAuthorizations] are done on ownership of [io.antarescircuit.jabbah.graph.project.Project]
