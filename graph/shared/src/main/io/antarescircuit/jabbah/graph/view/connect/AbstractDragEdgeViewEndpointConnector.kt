...
import io.antarescircuit.jabbah.draw.StateMachineInputEventHandler.Companion.altReleased
import io.antarescircuit.jabbah.draw.StateMachineInputEventHandler.Companion.escapePressed
...
abstract class AbstractDragEdgeViewEndpointConnector(
	...
	private fun completeConnectingToEdgeView(context: EditInputEventContext) {
		...
		LOG.userTrail("Move EdgeView ${edgeView!!.id} ${draggedEndpointType.name} endpoint " + "" +
			"to connect to EdgeView ${targetEdgeView!!.id} at $splitLocation")
	...
	private fun completeConnectingToEndpoint(context: EditInputEventContext) {
		...
		LOG.userTrail("Join EdgeView ${edgeView!!.id} ${draggedEndpointType.name} endpoint with " +
			"EdgeView ${targetEndpointView!!.edgeView.id} ${targetEndpointView!!.type.name}" +
			" endpoint at ${targetEndpointView!!.location}")
