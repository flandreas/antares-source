...
import io.antarescircuit.jabbah.graph.view.connect.AbstractDragEdgeViewEndpointConnector
...
enum class EdgeViewEndpointType {
	...
	abstract fun adjustTo(edgeView: EdgeView<*>, layoutIndex: Int, location: Point2D, origDirs: Set<Direction>?, destDirs: Set<Direction>?)
